...
import { cargarSelects, cargarPuntuaciones } from "./features/puntuaciones.js";
...
export function inicializarTabs() {
    document.querySelectorAll(".tab").forEach((btn) => {
        btn.addEventListener("click", () => {
            ...
            document.querySelectorAll(".tab").forEach((boton) => boton.classList.remove("activo"));
            ...
            if (id === "puntuaciones") Promise.all([cargarSelects(), cargarPuntuaciones()]);
